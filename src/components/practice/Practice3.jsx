        ...
        <div className="container">
          <div className="row justify-content-center g-4">
            <div className="col-12">
              <Swiper
                {...practiceSlider}
                className="swiper practice3-slider pb-65"
              >
                <div className="swiper-wrapper">
                  ...
                  >
                    <div className="practice-single3">
                      <div className="practice-image">
                        <img
                          src="assets/images/bg/practice31.png"
                          className="img-fluid"
                          alt="image"
                        />
                        <div className="practice-icon">
                          <img
                            src="assets/images/icons/practice31.svg"
                            alt=""
                          />
                        </div>
                      </div>
                  ...
                  >
                    <div className="practice-single3">
                      <div className="practice-image">
                        <img
                          src="assets/images/bg/practice32.png"
                          className="img-fluid"
                          alt="image"
                        />
                        <div className="practice-icon">
                          <img
                            src="assets/images/icons/practice32.svg"
                            alt=""
                          />
                        </div>
                      </div>
                  ...
                  >
                    <div className="practice-single3">
                      <div className="practice-image">
                        <img
                          src="assets/images/bg/practice33.png"
                          className="img-fluid"
                          alt="image"
                        />
                        <div className="practice-icon">
                          <img
                            src="assets/images/icons/practice33.svg"
                            alt=""
                          />
                        </div>
                      </div>
