                  ...
                  <div className="address-area">
                    ...
                    <ul className="address-list sibling3">
                      ...
                      <li>
                        ...
                        <div className="text">
                          <h4>Phone</h4>
                          <a href="tel:+91 9582678877">+91 9582678877</a>
                        </div>
                      </li>
                      <li>
                        <div className="icon">
      ...
      <form className="contact-form" onSubmit={handleSubmit}>
        <div className="row">
          ...
          <div className="col-lg-12 text-lg-start text-center">
            ...
            {state.succeeded && (
              <p className="mt-3 text-success">Thanks for reaching out! We'll get back to you soon.</p>
            )}
          </div>
        </div>
      </form>
          ...
          <div className="map-section pt-120 pb-0 overflow-hidden">
            <div className="container-fluid px-0">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d218.909859496189!2d77.36706605047073!3d28.61304129533933!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce57e4c8df143%3A0x3e7993a6c3056c48!2sBhutani%20Cyberpark!5e0!3m2!1sen!2sin!4v1729687552923!5m2!1sen!2sin"
                height={500}
                style={{ border: 0 }}
                allowFullScreen
                loading="lazy"
